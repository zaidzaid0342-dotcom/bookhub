    ...
    if (users.length > 0 && books.length > 0) {
      const booksWithSellerInfo = books.map(book => {
        ...
        let seller = users.find(user => 
          ...
          (book.seller && user._id === book.seller.toString())
        );
    ...
    if (users.length > 0 && offers.length > 0) {
      const offersWithBuyerInfo = offers.map(offer => {
        ...
        let buyer = users.find(user => 
          ...
          (offer.buyer && user._id === offer.buyer.toString())
        );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Admin Panel</h1>
          <p className="text-gray-600 max-w-2xl">Manage your platform's users, books, and offers from this centralized dashboard.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="p-6 bg-gradient-to-r from-purple-500 to-purple-600 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium mb-1">Total Offers</h3>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="p-6 bg-gradient-to-r from-amber-500 to-amber-600 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-medium mb-1">Pending Offers</h3>
            ...
            <div className="p-4 md:p-6">
              {offersWithBuyer.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">There are no offers yet.</p>
                </div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Offer Amount</th>
                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {offersWithBuyer.map(offer => (
                        <tr key={offer._id} className="hover:bg-gray-50 transition-colors duration-150">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-gray-900">${offer.offerPrice}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                ...
                {offerDetailsLoading ? (
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <h3 className="text-sm font-medium text-gray-500">Offer Amount</h3>
                        <p className="text-lg font-medium">${selectedOffer.offerPrice}</p>
                      </div>
                      <div>
                    ...
                    {selectedOffer.message && (
                      <div>
                        ...
                        <p className="text-gray-700 bg-gray-50 p-3 rounded-lg">{selectedOffer.message}</p>
                      </div>
                    )}
                    ...
                    <div className="pt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-green-50 p-4 rounded-lg">
                          <p className="text-sm text-green-800">Offers Made</p>
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg">
                          <p className="text-sm text-purple-800">Offers Received</p>
